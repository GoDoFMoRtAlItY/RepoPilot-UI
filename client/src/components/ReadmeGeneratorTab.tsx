    ...
    >
      ...
      <div className="glass-panel p-6 rounded-xl relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-4 shrink-0">
        ...
        <div className="space-y-2 relative z-10 flex-1">
          ...
          <h2 className="text-xl md:text-2xl font-bold text-white tracking-tight font-sans flex items-center gap-2">
            README.md Auto-Generator
            {aiKey && <span className="text-[10px] bg-cyan-500/20 text-cyan-400 px-2 py-0.5 rounded uppercase border border-cyan-500/30">Gemini Powered</span>}
          </h2>
        ...
        <div className="relative z-10 shrink-0">
          <button
            ...
            className="flex items-center space-x-2 px-5 py-3 bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 text-white rounded-lg font-bold text-sm shadow-[0_0_15px_rgba(34,211,238,0.3)] transition-all active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isGenerating ? (
              <>
      ...
      {/* Content Area */}
      <div className="flex-1 glass-panel rounded-xl border-slate-800/80 overflow-hidden flex flex-col relative min-h-0">
          ...
          <>
            <div className="flex items-center justify-between px-4 py-3 border-b border-slate-800/80 bg-slate-900/50 shrink-0">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs font-bold text-slate-300">README.md</span>
              </div>
              <div className="flex items-center space-x-2">
                <button
                  onClick={handleCopy}
                  className="flex items-center space-x-1.5 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded transition-colors text-[10px] uppercase font-bold"
                >
